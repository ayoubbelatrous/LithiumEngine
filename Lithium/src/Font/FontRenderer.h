...
namespace Lithium
{
	...
	public:
		...
		static void DrawString(const glm::vec2& Position,float Scale,const std::string& text,const Ref<Font>& font, const glm::vec4& color, float Spacing = 0, float LineSpacing = 0,int EntityID = 0);
